...
export function ServiceCatalogSettings() {
  ...
  // Buscar catalogos (incluindo inativos para administracao)
  const { data: catalogs = [], isLoading } = useQuery({
    queryKey: ['service-catalogs'],
    queryFn: () => serviceCatalogService.getAllIncludingInactive(),
  });

  // Mutation para toggle ativo/inativo do catalogo
  ...
  // Mutation para excluir catalogo
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Gerencie os catalogos de servico e suas categorias para classificar os tipos de atendimento.
          </p>
        </div>
        <button
      ...
      {catalogs.length === 0 ? (
        <div className="text-center py-12 bg-gray-50 dark:bg-gray-900 rounded-lg border border-dashed border-gray-300 dark:border-gray-700">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-4">
            Crie seu primeiro catalogo de servico para classificar os tipos de atendimento.
          </p>
          <button
            onClick={handleCreateCatalog}
          ...
          {catalogs.map((catalog) => {
            ...
            return (
              ...
              >
                ...
                {/* Categorias do Catalogo (expandido) */}
                {isExpanded && (
                  <div className="border-t border-gray-200 dark:border-gray-700 p-4">
                    ...
                    {categories.length === 0 ? (
                      <p className="text-sm text-gray-500 dark:text-gray-400 italic py-4 text-center">
                        Nenhuma categoria cadastrada. Adicione categorias para classificar os tipos de servico.
                      </p>
                    ) : (
      ...
      {/* Modal de Criacao/Edicao de Catalogo */}
      {isCatalogModalOpen && (
        <ServiceCatalogModal
